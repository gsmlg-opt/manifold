...
before migration. Migration `20260811000100` performs lossless rollback
preflights; `20260811000200` requires a unique legacy receive event anchor; and
`20260811000300` refuses rollback while Gmail or SMTP submissions exist.

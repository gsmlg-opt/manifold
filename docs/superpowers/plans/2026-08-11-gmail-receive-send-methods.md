...
- Create: `apps/manifold_data/priv/repo/migrations/20260811000500_add_shared_gmail_authorizations.exs`
...
```sh
git add apps/manifold_data/priv/repo/migrations/20260811000500_add_shared_gmail_authorizations.exs \
...
if ! git diff --quiet; then
  git add -- apps/manifold_connectors apps/manifold_outbound apps/manifold_web \
    apps/manifold_data/priv/repo/migrations/20260811000500_add_shared_gmail_authorizations.exs \

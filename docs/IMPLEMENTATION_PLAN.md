...
8. Minimal authenticated Phoenix LiveView operational views.
...
8. Add `manifold_web` with Phoenix LiveView, owner authentication, and operational list/detail pages through public context APIs.
   - Verify: web tests cover authenticated access, unauthenticated rejection, context-backed detail loading, and no raw public URLs.
...
- Oban archival is idempotent and leaves the ready spool bundle in place until archived state commits.
